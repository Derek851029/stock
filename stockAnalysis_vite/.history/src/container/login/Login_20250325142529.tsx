...
export default function Login() {
  const [formData, setFormData] = useState({ acc: "", pwd: "" });
  ...
  const doLogin = (event: FormEventHandler) => {
    console.log(event);
    return;
    // api.post()
  };
              ...
              <FormControl>
                <Input
                  ...
                  className={`w-full bg-gray-800 border ${
                    errors.acc ? "border-red-500" : "border-neon"
                  } text-white p-2 rounded`}
                  placeholder="請輸入帳號"
                />
              </FormControl>
              <FormMessage>{errors.acc}</FormMessage>
            </FormItem>
          </FormField>
            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-gray-800 border ${
                    errors.pwd ? "border-red-500" : "border-neon"
                  } text-white p-2 rounded`}
                  placeholder="請輸入密碼"
                />
              </FormControl>
              <FormMessage>{errors.pwd}</FormMessage>
            </FormItem>
          </FormField>
