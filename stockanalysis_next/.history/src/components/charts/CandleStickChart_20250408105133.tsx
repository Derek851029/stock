...
const CandleStickChart: React.FC<ChartProps> = memo(
  ({ chartData, handleCandleStickHover, width }) => {
    ...
    useEffect(() => {
      ...
      chart.subscribeCrosshairMove((param) => {
        ...
        const volumeSeriesData = param.seriesData.get(
          volumeSeries
        ) as ChartItem;
...
function checkChartData(oldProps: ChartProps, newProps: ChartProps) {
  if (newProps.chartData.length > 0) {
    return false;
  } else {
    return false;
  }
